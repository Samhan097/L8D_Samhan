...
export const Services = ({ cardStates, className }) => {
          ...
          {state.cardStates === "branding" && (
            <>
              <img
                className="frame"
                alt="Frame"
                src="https://cdn.animaapp.com/projects/655b5c17f4acb9cb5701b449/releases/655b5d14270a8adb1f01a784/img/frame-79.svg"
              />
